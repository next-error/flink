...
public class C05_StreamSQLWordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple2<String, Integer>> tpStream1 = lines.map(new MapFunction<String, Tuple2<String, Integer>>() {
            @Override
        ...
        //指定字段的名称和类型的 Stream的泛型要是自己定义的Bean,返回Tuple会报错
