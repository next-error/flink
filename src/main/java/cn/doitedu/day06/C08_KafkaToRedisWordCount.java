...
public class C08_KafkaToRedisWordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //设置flink job对应的checkPoint的
        //StreamExecutionEnvironment environment = env.setStateBackend(new FlatMapFunction<>("hdfs://linux01:8020/checkpoint220628"));
        //将job在web页面cancel后,不删除checkPoint目录
